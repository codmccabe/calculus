...
if we let $f(x) = \ln(x)$ and $g(x) = 1+2x$, then we can express
...
\begin{explanation}
Set $f(x) = \ln(x)$ and $g(x) = 1+2x$, now
\[
f'(x) = \answer[given]{\frac{1}{x}} \qquad\text{and}\qquad g'(x) = \answer[given]{2}.
\]
Hence
\begin{align*}
\ddx \ln(1+2x) &= \ddx f(g(x))\\
&=f'(g(x))g'(x) \\
&= \frac{1}{\answer[given]{1+2x}}\cdot \answer[given]{2}\\
&= \frac{2}{1+2x}.
\end{align*}
\end{explanation}
\end{example}
...
\begin{explanation}
Set $f(x) = \answer[given]{e^x}$, $g(x) = \answer[given]{\sqrt{x}}$, and $h(x) = \answer[given]{x^2+1}$
so that $f(g(h(x))) = e^{\sqrt{x^2+1}}$. Now
\begin{align*}
  \ddx e^{\sqrt{x^2+1}} &= \ddx f(g(h(x)))\\
  & = f'(g(h(x))) \cdot g'(h(x)) \cdot h'(x)\\
  & = e^{\answer[given]{\sqrt{x^2+1}}}\cdot \frac{1}{2\sqrt{\answer[given]{x^2+1}}}\cdot \answer[given]{2x}
\end{align*}
\end{explanation}
\end{example}
