...
\activity{understandingFunctions/digInInversesOfFunctionsB.tex}


%% Review of famous functions
\chapterstyle
\activity{reviewOfFamousFunctions/titlePageB.tex}
\sectionstyle
...
\activity{whatIsALimit/digInWhatIsALimitB.tex}  %Still would like to add a $\sin(1/x)$ type function to the first part of the sections...
...
\activity{limitLaws/digInLimitLawsB.tex}
...
\activity{appliedRelatedRates/digInAppliedRelatedRatesB.tex}
