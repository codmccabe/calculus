...
\begin{example}
  ...
  \]
  \begin{explanation}
    We start by finding an antiderivative of $\frac{1}{x}$.  A correct
    choice is $\ln|x|$, one could verify this by taking the
    derivative. Hence
    \begin{align*}
      \int_1^e \frac{1}{x} \d x &= \eval{\ln|x|}_1^e\\
      &=\answer[given]{\ln(e)} - (\ln(0))\\
      &=\answer[given]{1}.
    \end{align*}
