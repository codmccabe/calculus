...
Consider the one-sided limits separately.
 ...
 When $x\to 3^+$, the quantity $(x-3)$ is positive and approaches $0$ and the numerator is negative; therefore, $\lim_{x\to 3^+} f(x) = -\infty$.

 On the other hand,  when $x\to 3^-$, the quantity $(x-3)$ is negative and approaches $0$ and the numerator is negative; therefore, $\lim_{x\to 3^-} f(x) = \infty$.
