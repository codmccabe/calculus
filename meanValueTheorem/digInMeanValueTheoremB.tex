...
\begin{example}
Describe all functions whose derivative is $2x$.
\begin{explanation}
One such function is $x^2$, so all such functions have the form
$x^2+k$,
%% \begin{marginfigure}[0in]
\begin{image}
\begin{tikzpicture}
	\begin{axis}[
            xmin=0, xmax=4.2,ymin=-3,ymax={4^2+2},domain=(0:4),
            axis lines =center, xlabel=$x$, ylabel=$y$,
            every axis y label/.style={at=(current axis.above origin),anchor=south},
            every axis x label/.style={at=(current axis.right of origin),anchor=west},
            axis on top,
          ...
          \addplot [very thick,penColor2!30!background, smooth] {x^2+1};
          \addplot [very thick,penColor3!30!background, smooth] {x^2-1};
          \addplot [very thick,penColor4!30!background, smooth] {x^2+2};
          \addplot [very thick,penColor5!30!background, smooth] {x^2-2};
        \end{axis}
\end{tikzpicture}
